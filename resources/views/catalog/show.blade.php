	...
	<div class="row">
		...
		{{-- TODO: Datos de la película --}}
			...
			<p>
				...
				<a class="btn btn-warning btn-lg" href="#" role="button"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Editar película</a>
				<a class="btn btn-default btn-lg" href="#" role="button"><span class="glyphiconglyphicon-fast-backward" aria-hidden="true"></span>Volver al listado</a>
			</p>
		</div>
	</div>
@stop